...
export default function Loader(): ILoader {
  async function loadVisualElements(): Promise<Record<string, VisualElement>> {
    return {
      boy: {name: 'boy', data: new Blob([boy],{type:"image/svg+xml;charset=utf-8"} )},
      coffee: {name: 'coffee', data: new Blob([coffee],{type:"image/svg+xml;charset=utf-8"} )},
      meat: {name: 'meat', data: new Blob([meat],{type:"image/svg+xml;charset=utf-8"} )},
      pizza: {name: 'pizza', data: new Blob([pizza],{type:"image/svg+xml;charset=utf-8"} )},
      salad: {name: 'salad', data: new Blob([salad],{type:"image/svg+xml;charset=utf-8"} )},
      steak: {name: 'steak', data: new Blob([steak],{type:"image/svg+xml;charset=utf-8"} )},
      fries: {name: 'fries', data: new Blob([fries],{type:"image/svg+xml;charset=utf-8"} )},
      hands: {name: 'hands', data: new Blob([hands],{type:"image/svg+xml;charset=utf-8"} )},
    }
  }
